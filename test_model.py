...
def test_predictions_length():
    """Test 2 (na 5): Sprawdza, czy długość listy predykcji jest > 0 i odpowiada próbkom testowym."""
...
def test_predictions_value_range():
    """Test 3 (na 5): Sprawdza, czy wartości mieszczą się w zakresie dla zbioru Iris (0, 1, 2)."""
    preds, _ = train_and_predict()
